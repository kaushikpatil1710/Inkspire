...
const Logo = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"  viewBox="0 0 16 16">
            ...
            <text x="150" y="120" fontFamily="Arial, sans-serif" fontSize="24" fontWeight="bold" textAnchor="middle" fill="black">
                INKSPIRE
            </text>
            <text x="150" y="150" fontFamily="Arial, sans-serif" fontSize="14" textAnchor="middle" fill="black">
                Ink your thoughts
            </text>
        </svg >
